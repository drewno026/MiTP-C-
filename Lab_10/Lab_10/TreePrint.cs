...
namespace B10
{
    // this class is for tree display only
    // using a modified version of code from https://stackoverflow.com/questions/36311991/c-sharp-display-a-binary-search-tree-in-console
    // careful: DO NOT USE for very large trees
    static class TreePrint
    {
        ...
        public static void Print(this TreeNode root, int topMargin = 2, int leftMargin = 2)
        {
            ...
            catch(ArgumentOutOfRangeException e)
            {
                ...
                Console.Clear();
                if (e.Message.Contains("buffer")) Console.WriteLine("The tree is too large to be printed in the console!");
        ...
        private static void Print(string s, int top, int left, int right = -1)
        {
            ...
            while (Console.CursorLeft < right
                && Console.CursorLeft < Console.BufferWidth - s.Length -1) Console.Write(s);
        }
